...
const NavBar = () => {
  ...
  return (
    <nav className="bg-gray-800 text-white p-4 h-16 flex items-center justify-between flex-wrap relative">
      ...
      {/* Hamburger Icon */}
      <button onClick={() => setIsOpen(!isOpen)} className="text-white inline-flex p-3 hover:bg-gray-700 rounded lg:hidden ml-auto hover:text-white outline-none">
      ...
      <div className={`${
        ...
        <ul className="space-y-1">
          <li><a href="#about" className="block px-3 py-2 hover:text-gray-300">About</a></li>
          <li><a href="#skills" className="block px-3 py-2 hover:text-gray-300">Skills</a></li>
          <li><a href="#experience" className="block px-3 py-2 hover:text-gray-300">Experience</a></li>
          <li><a href="#projects" className="block px-3 py-2 hover:text-gray-300">Projects</a></li>
          <li><a href="#contact" className="block px-3 py-2 hover:text-gray-300">Contact</a></li>
        </ul>
      </div>
